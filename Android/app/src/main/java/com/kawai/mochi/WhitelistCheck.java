...
class WhitelistCheck {
    ...
    static boolean isPackageInstalled(String packageName, PackageManager packageManager) {
        ...
        try {
            android.content.Intent intent = new android.content.Intent("com.whatsapp.intent.action.ENABLE_STICKER_PACK");
            intent.setPackage(packageName);
            java.util.List<android.content.pm.ResolveInfo> list = packageManager.queryIntentActivities(intent, 0);
